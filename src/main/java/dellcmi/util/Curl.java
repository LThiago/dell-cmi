...
public class Curl {
    ...
    public Curl(String hostname, int port, final boolean verbose, final boolean basicAuth) {
        ...
        localcontext = this.createLocalContext(); //HttpClientContext.create();
    }
    ...
    private int executeRequest(HttpRequestBase method) throws Exception{
        try {
    ...
    public int createAndExecuteMethodWithHeaders(String type, String url, String data, boolean upload, boolean multipart, String... headers)
        throws Exception {
    ...
    public int issueRequestWithHeaders(String type, String url, String data, String... headers) throws Exception{
